 ...
 * @author user
 */
public class PaymentsDebit extends javax.swing.JFrame {

    /**
     * Creates new form PaymentsDebit
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PaymentsDebit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PaymentsDebit().setVisible(true);
            }
        });
    }
